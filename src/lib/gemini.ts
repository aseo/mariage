...
정상 객체 스키마(각 1개 요소. 예시는 스키마 구조만 참고하세요. 데이터는 임의의니 실제 추천 논리에 절대 사용 금지):
rank (number: 1|2|3)
category (string: 예 "맥주", "와인", "위스키" 등)
name (string: 예 "라거", "소주", "피노 누아")
...
정상 출력 예(예시는 구조만 참고하세요. 데이터는 임의의니 실제 추천 논리에 절대 사용 금지):
[
{
{
"rank": 1,
...
"grade": "A",
"emoji": "🍺",
"explanation": "깔끔한 청량감이 느끼한 맛을 정리해주고, 부드러운 목넘김이 어떤 음식과도 잘 어울려요. 시원하게 마시면 최고의 궁합을 보여줍니다.",
"imagePlaceholder": "🍺"
},
{
"rank": 3,
...
사용자가 입력한 술(예: 페일에일, 피노 누아, 버번 위스키 등)에 어울리는 요리 3가지를 추천해주세요.
...
사용자가 포괄적인 '맥주'를 입력했다면, 맥주 스타일(예: 라거, 페일 에일, 스타우트, IPA 등)을 언급하고, 스타일 기준으로 페어링 및 코멘트
